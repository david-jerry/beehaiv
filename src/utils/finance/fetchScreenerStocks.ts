import { PredefinedScreenerModule } from "../../../types/yfinance.global"

import type { ScreenerOptions, ScreenerResult } from './../../../node_modules/yahoo-finance2/dist/esm/src/modules/screener';
...
export async function fetchScreenerStocks(query: string, count?: number) {
    ...
    const queryOptions: ScreenerOptions = {
        scrIds: query as PredefinedScreenerModule,
